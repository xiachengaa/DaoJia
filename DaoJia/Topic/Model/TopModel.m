...
- (void)setAttributes:(NSDictionary *)jsonDic {
    ...
    self.avatar = [jsonDic objectForKey:@"Avatar"];
    self.userName = [jsonDic objectForKey:@"UserName"];
    self.imaUrl = [jsonDic objectForKey:@"Img"];
    self.topicId = [[jsonDic objectForKey:@"TopicId"]integerValue];
    self.userId = [[jsonDic objectForKey:@"userId"]integerValue];
    self.previewContent = [jsonDic objectForKey:@"PreviewContent"];
    _desc = [jsonDic objectForKey:@"Desc"];
    _address = [jsonDic objectForKey:@"Address"];
//    _intro = [jsonDic objectForKey:@"intro"];
    _commonInfo = [jsonDic objectForKey:@"CommonInfo"];
